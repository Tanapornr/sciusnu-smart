...
![ขั้นตอนนักเรียนอัปโหลดงาน](docs/images/student-upload-steps.svg)

> กรอบอธิบายภาพ: ภาพนี้ขยายขั้นตอนส่งงานครั้งแรก นักเรียนเลือกประเภทงาน แนบไฟล์ PDF แล้วกดอัปโหลด ระบบจะบันทึกไฟล์ลง Google Drive บันทึกประวัติลง Google Sheet และเปลี่ยนสถานะเป็นรอตรวจหรือรออนุมัติ พร้อมส่งอีเมลแจ้งผู้เกี่ยวข้อง
...
![ขั้นตอนนักเรียนส่งไฟล์แก้ไข](docs/images/student-revision-steps.svg)

> กรอบอธิบายภาพ: ภาพนี้แสดงขั้นตอนหลังงานไม่อนุมัติ นักเรียนอ่านหมายเหตุจากอาจารย์ กด `ส่งไฟล์แก้ไข` จากรายการเดิม ระบบจะล็อกประเภทงานให้ตรงกับงานที่ต้องแก้เท่านั้น จากนั้นนักเรียนแนบไฟล์ใหม่และส่งกลับไปให้อาจารย์ตรวจอีกครั้ง
...
![ขั้นตอนแอดมินตรวจแบบคำร้อง](docs/images/admin-petition-steps.svg)

> กรอบอธิบายภาพ: ภาพนี้แสดงขั้นตอนของแอดมินเมื่อมีแบบคำร้องใหม่ ระบบจะส่งอีเมลหาแอดมิน แอดมินเปิดหน้า `admin.html` ตรวจไฟล์คำร้อง แล้วกดอนุมัติหรือไม่อนุมัติ หากอนุมัติ ระบบจะแจ้งนักเรียนและอาจารย์ที่เกี่ยวข้อง
...
![ขั้นตอน Deploy Google Apps Script](docs/images/apps-script-deploy-steps.svg)

> กรอบอธิบายภาพ: ภาพนี้สรุปขั้นตอนหลังแก้ `Code.gs` ให้กด Deploy เป็นเวอร์ชันใหม่ แล้วนำ URL `/exec` ล่าสุดไปวางในไฟล์หน้าเว็บทุกหน้าที่เรียก API เพื่อให้ระบบใช้สคริปต์เวอร์ชันใหม่จริง
